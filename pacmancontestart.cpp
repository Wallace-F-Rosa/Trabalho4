...
char MAPA[26][26] =
{
    ...
    "1110111101122211011110111",
    "1000000001122211000000001",
    "1011111101111111011111101",
    "1011100000002000000011101",
...
float xscore = 1*q, yscore = 25*q;
char pac_estado;
float mpillsdy[25][25];
float mpillsdx[25][25];
int qscore = 0;
float xp1score = 9*q, xp2score = 10.32*q, xp3score = 11.6*q;
float yp1score = 24.9*q, yp2score = 24.9*q, yp3score = 24.9*q;
